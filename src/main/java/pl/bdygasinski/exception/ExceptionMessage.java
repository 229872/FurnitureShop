...
public class ExceptionMessage {
    ...
    public static final String INVALID_CREDENTIALS_EXCEPTION = "exception.account.auth.credentials.invalid";
    public static final String CANT_AUTH_TO_NOT_ACTIVE_ACCOUNT = "exception.account.auth.notactive";
}
